...
class ImageNet_test_Dataset(Dataset):
    def __init__(self,mode,dataset_path='training/image_mask/resized_image'):
    #def __init__(self,mode,dataset_path='training/image_mask/resized_image'):
        ...
        if mode=='visualization':
            self.dataset_path='/home/cn/inpainting_examples/data'
            self.visualization_path='/home/cn/inpainting_examples/mask'
            with open("/home/cn/inpainting_examples/caption.json") as f:
                data_dict= json.load(f)
    ...
    def __getitem__(self, item):
        ...
        img_name=i_name[:-5]+'_crop000.png'
        mask_name=i_name[:-5]+'_crop000_mask000.png'
        ...
        if self.mode=='medium':
            ...
            mask_path=os.path.join(self.visualization_path,mask_name)
