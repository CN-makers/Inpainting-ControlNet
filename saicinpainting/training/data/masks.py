...
class MixedMaskGenerator:
    def __init__(self, irregular_proba=1, irregular_kwargs=None,
        ...
        #default  
        '''
        irregular_kwargs={max_angle:4,max_len:200,max_width=100,max_times:5,min_times:1}
        box_kwargs={ margin: 10,bbox_min_size: 30,bbox_max_size: 150,max_times: 4，min_times: 1}
        '''
        self.probas = []
        self.gens = []
